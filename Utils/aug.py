...
class TUDataset_aug(InMemoryDataset):
    ...
    def __init__(self, root, name, transform=None, pre_transform=None,
        ...
        super(TUDataset_aug, self).__init__(root, transform, pre_transform,
                                        pre_filter)
        self.data, self.slices = torch.load(self.processed_paths[0])[0],torch.load(self.processed_paths[0])[1]
    ...
    def get_num_feature(self):
        ...
        for key in self.data.keys:
            if hasattr(self.data, '__num_nodes__') and not hasattr(self.slices, '__num_nodes__'):
                break
    ...
    def get(self, idx):
        ...
        # print(self.data)
        # print(self.slices)
        # if not hasattr(self.slices, 'num_nodes'):
        #     self.slices.num_node = self.data.num_nodes
        for key in self.data.keys():
        ...
        if self.aug == 'dnodes':
            ...
            # print(np.random.choice(5, 1, p=self.aug_P))
